...
from utility.sampling import mnist_iid, mnist_noniid, fmnist_noniid, cifar_iid, cifar_noniid, cifar100_noniid
...
def Load_Model(args):
    ...
    Function to load the required architecture (model) for federated learning 加载模型
